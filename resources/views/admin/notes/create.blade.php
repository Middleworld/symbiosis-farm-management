    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-plus"></i> Create New {{ ucfirst($type) }} Note
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.notes.store') }}" method="POST">
                    ...
                    @if($task)
                        ...
                        <div class="alert alert-info mb-3">
                            ...
                            This note will be linked to task: <strong>{{ $task->title }}</strong>
                        </div>
                    @endif
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('admin.notes.index', ['type' => $type]) }}" class="btn btn-secondary">
