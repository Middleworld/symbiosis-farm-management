...
@section('title', 'Create Shipping Class')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Shipping Class</h3>
                ...
                <form action="{{ route('admin.shipping-classes.store') }}" method="POST">
                                ...
                                <div class="col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="is_farm_collection" name="is_farm_collection" value="1"
                                               {{ old('is_farm_collection') ? 'checked' : '' }}>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Create Shipping Class
                        </button>
