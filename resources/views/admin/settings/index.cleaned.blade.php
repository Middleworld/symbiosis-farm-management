                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="mb-3"><i class="fas fa-heart"></i> Solidarity Pricing Defaults</h6>
                                <p class="text-muted small">Set default percentages for pay-what-you-can pricing zones</p>
                                
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="solidarity_min_percent" class="form-label">Minimum % <small class="text-muted">(Solidarity)</small></label>
                                        ...
                                        <small class="text-muted">Default: 70% of recommended price</small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="solidarity_max_percent" class="form-label">Maximum % <small class="text-muted">(Supporter)</small></label>
                                        <div class="input-group">
                                        ...
                                        <small class="text-muted">Default: 167% of recommended price</small>
                                    </div>
                                </div>
                                
                                <div class="alert alert-info" style="font-size: 12px;">
                                    <strong>ℹ️ Note:</strong> These percentages are used as defaults when enabling solidarity pricing on products.
                                </div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const triggerTabList = [].slice.call(document.querySelectorAll('#settingsTabs button[data-bs-toggle="tab"]'));
...
// RAG Drag & Drop File Upload
    ...
    // Scale Integration Type Selector
    const scaleIntegrationSelect = document.getElementById('pos_scale_integration');
    if (scaleIntegrationSelect) {
        function toggleScaleSettings() {
            const selectedType = scaleIntegrationSelect.value;
            
            // Hide all settings sections
            document.querySelectorAll('.scale-settings-section').forEach(section => {
            ...
            switch(selectedType) {
                case 'web_serial':
                    document.getElementById('web-serial-settings').style.display = 'block';
                    break;
                case 'web_bluetooth':
                    document.getElementById('web-bluetooth-settings').style.display = 'block';
                    break;
                case 'websocket':
                    document.getElementById('websocket-settings').style.display = 'block';
                    break;
                case 'manual':
                default:
                    document.getElementById('manual-entry-info').style.display = 'block';
                    break;
            }
        }
        ...
        scaleIntegrationSelect.addEventListener('change', toggleScaleSettings);
    }
        ...
        function toggleCardReaderSettings() {
            ...
            switch(selectedType) {
                case 'stripe_terminal':
                    ...
                    break;
                case 'square_reader':
                    document.getElementById('square-reader-settings').style.display = 'block';
                    break;
                case 'web_nfc':
                    document.getElementById('web-nfc-settings').style.display = 'block';
                    break;
                case 'websocket_terminal':
                    document.getElementById('websocket-terminal-settings').style.display = 'block';
                    break;
                case 'manual':
                default:
    ...
    const printerTypeSelect = document.getElementById('pos_printer_type');
    if (printerTypeSelect) {
        function togglePrinterSettings() {
            const selectedType = printerTypeSelect.value;
            
            // Hide all printer sections
            document.querySelectorAll('.printer-section').forEach(section => {
                section.style.display = 'none';
            });
            ...
            switch(selectedType) {
                case 'network_printer':
                    document.getElementById('network-printer-settings').style.display = 'block';
                    break;
                case 'websocket_printer':
                    document.getElementById('websocket-printer-settings').style.display = 'block';
                    break;
                case 'star_micronics':
                    document.getElementById('star-printer-settings').style.display = 'block';
                    break;
                case 'epson':
                    document.getElementById('epson-printer-settings').style.display = 'block';
                    break;
                case 'browser':
                default:
                    document.getElementById('browser-print-info').style.display = 'block';
                    break;
            }
        }
        ...
        // Update when selection changes
        printerTypeSelect.addEventListener('change', togglePrinterSettings);
    }
});
</script>
@endsection
