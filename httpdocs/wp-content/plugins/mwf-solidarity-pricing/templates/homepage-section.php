        ...
        <div class="mwf-solidarity-grid">
            ...
            <div class="mwf-solidarity-card mwf-solidarity-pricing">
                ...
                <div class="mwf-solidarity-pricing-tiers">
                    <!-- Solidarity Tier -->
                    <div class="mwf-solidarity-tier solidarity-tier" data-trigger-modal data-tier="solidarity">
                    ...
                    <!-- Standard Tier -->
                    <div class="mwf-solidarity-tier standard-tier" data-trigger-modal data-tier="standard">
                        <div class="tier-icon">🌱</div>
                        <div class="tier-content">
                    ...
                    <!-- Supporter Tier -->
                    <div class="mwf-solidarity-tier supporter-tier" data-trigger-modal data-tier="supporter">
                        <div class="tier-icon">🌳</div>
                        <div class="tier-content">
...
<!-- Homepage tier clicks now handled by solidarity-modal.js via event delegation -->
