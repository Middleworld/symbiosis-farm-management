...
(function($) {
    ...
    const SolidarityModal = {
        ...
        init: function() {
            console.log('[MWF Solidarity] Initializing modal');
            console.log('[MWF Solidarity] jQuery version:', $.fn.jquery);
            this.bindEvents();
            this.checkAndShow();
        },
         ...
         */
        bindEvents: function() {
            console.log('[MWF Solidarity] Binding events');
            const self = this;
            ...
            // Transparency banner - open main modal
            $(document).on('click', '.mwf-solidarity-transparency', function(e) {
                e.preventDefault();
                e.stopPropagation();
                self.showModal();
            });
            
            // CTA button with data-trigger-modal - open main modal
            ...
            $(document).on('click', '.mwf-solidarity-tier', function(e) {
                e.preventDefault();
                e.stopPropagation();
    ...
    $(document).ready(function() {
        try {
            ...
            console.error('[MWF Solidarity] Initialization error:', error);
        }
    });
