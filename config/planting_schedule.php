...
return [
    ...
    'crops' => [
        ...
        'broccoli_standard' => [
            ...
            'in_row_spacing_cm' => 45,
            'transplant_lead_weeks' => 5,
            'notes' => 'Plant every 3-4 weeks for continuous harvest. Standard broccoli varieties.'
        ],
        'calabrese' => [
            'name' => 'Calabrese',
            'family' => 'brassicaceae',
            ...
            'earliest_week' => 14,
            'latest_week' => 26,
            'succession_interval_weeks' => 5,
            'days_to_maturity' => 90,
            'frost_tolerance' => 'half-hardy',
            'row_spacing_cm' => 45,
            'in_row_spacing_cm' => 45,
            'transplant_lead_weeks' => 5,
            'notes' => 'Plant every 4-5 weeks. Sprouting broccoli varieties for summer harvest.'
        ],
        'psb' => [
            'name' => 'Purple Sprouting Broccoli (PSB)',
            'family' => 'brassicaceae',
            'methods' => ['transplant'],
            'earliest_week' => 16,
            'latest_week' => 28,
            'succession_interval_weeks' => 7,
            'days_to_maturity' => 240,
            'frost_tolerance' => 'hardy',
            'row_spacing_cm' => 45,
            'in_row_spacing_cm' => 45,
            'transplant_lead_weeks' => 6,
            'notes' => 'Plant every 6-8 weeks. Winter/spring harvest varieties. Very long maturity.'
        ],
    ],
];
