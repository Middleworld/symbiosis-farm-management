    ...
    <div class="row g-4 settings-layout">
        <div class="col-12 col-lg-3">
                ...
                <div class="wizard-steps-indicator">
                    ...
                    <div class="step-item" data-step="7">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-desc">Identity</div>
                        </div>
                    </div>
            ...
            <div class="row g-3">
                    ...
                    <!-- Step 7: Branding & Identity -->
                    <div class="wizard-step" data-step="7">
                        <h3 class="mb-4"><i class="fas fa-palette text-primary"></i> Branding & Identity</h3>
                        <p class="text-muted mb-4">Configure your company branding, colors, logos, and identity across all platforms.</p>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="brand_company_name" class="form-label">
                                                <strong>Company Name</strong>
                                            </label>
                                            <input type="text" class="form-control" id="brand_company_name" 
                                                   name="brand_company_name" 
                                                   value="{{ $branding->company_name ?? 'Middleworld Farms' }}" 
                                                   placeholder="Middleworld Farms">
                                        </div>
                                        <div class="mb-3">
                                            <label for="brand_tagline" class="form-label">
                                                <strong>Tagline / Slogan</strong>
                                            </label>
                                            <input type="text" class="form-control" id="brand_tagline" 
                                                   name="brand_tagline" 
                                                   value="{{ $branding->tagline ?? '' }}" 
                                                   placeholder="Sustainable farming with modern technology">
                                        </div>
                                        <div class="mb-3">
                                            <label for="brand_logo_alt_text" class="form-label">
                                                <strong>Logo Alt Text</strong>
                                            </label>
                                            <input type="text" class="form-control" id="brand_logo_alt_text" 
                                                   name="brand_logo_alt_text" 
                                                   value="{{ $branding->logo_alt_text ?? 'Middleworld Farms Logo' }}" 
                                                   placeholder="Middleworld Farms Logo">
                                            <div class="form-text">
                                                <i class="fas fa-universal-access"></i> Used for accessibility and SEO
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border-success">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">Main brand color (headers, buttons, links)</div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">Secondary accents and highlights</div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="color" class="form-control form-control-color" 
                                                       id="brand_accent_color" name="brand_accent_color" 
                                                       value="{{ $branding->accent_color ?? '#f5c518' }}">
                                                <input type="text" class="form-control" 
                                                       value="{{ $branding->accent_color ?? '#f5c518' }}" 
                                                       readonly>
                                            </div>
                                            <div class="form-text">Call-to-action buttons, special highlights</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="brand_contact_email" class="form-label">
                                                <strong>Contact Email</strong>
                                            </label>
                                            <input type="email" class="form-control" id="brand_contact_email" 
                                                   name="brand_contact_email" 
                                                   value="{{ $branding->contact_email ?? '' }}" 
                                                   placeholder="info@middleworldfarms.org">
                                        </div>
                                        <div class="mb-3">
                                            <label for="brand_contact_phone" class="form-label">
                                                <strong>Contact Phone</strong>
                                            </label>
                                            <input type="tel" class="form-control" id="brand_contact_phone" 
                                                   name="brand_contact_phone" 
                                                   value="{{ $branding->contact_phone ?? '' }}" 
                                                   placeholder="+44 1234 567890">
                                        </div>
                                        <div class="mb-3">
                                            <label for="brand_address" class="form-label">
                                                <strong>Physical Address</strong>
                                            </label>
                                            <textarea class="form-control" id="brand_address" 
                                                      name="brand_address" rows="3" 
                                                      placeholder="123 Farm Lane, Village, County, Postcode">{{ $branding->address ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card border-warning">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="brand_social_facebook" class="form-label">
                                                <i class="fab fa-facebook"></i> Facebook
                                            </label>
                                            <input type="url" class="form-control" id="brand_social_facebook" 
                                                   name="brand_social_facebook" 
                                                   value="{{ $branding->social_links['facebook'] ?? '' }}" 
                                                   placeholder="https://facebook.com/yourpage">
                                        </div>
                                        <div class="mb-3">
                                            <label for="brand_social_instagram" class="form-label">
                                                <i class="fab fa-instagram"></i> Instagram
                                            </label>
                                            <input type="url" class="form-control" id="brand_social_instagram" 
                                                   name="brand_social_instagram" 
                                                   value="{{ $branding->social_links['instagram'] ?? '' }}" 
                                                   placeholder="https://instagram.com/yourpage">
                                        </div>
                                        <div class="mb-3">
                                            <label for="brand_social_twitter" class="form-label">
                                                <i class="fab fa-twitter"></i> Twitter / X
                                            </label>
                                            <input type="url" class="form-control" id="brand_social_twitter" 
                                                   name="brand_social_twitter" 
                                ...
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <!-- Main Logo -->
                                            <div class="col-md-4 mb-3">
                                                <label for="brand_logo_main" class="form-label">
                                                ...
                                                <input type="file" class="form-control" 
                                                       id="brand_logo_main" 
                                                       name="brand_logo_main" 
                                                       accept="image/png,image/jpeg,image/svg+xml">
                                                <div class="form-text">
                                                    <i class="fas fa-info-circle"></i> Recommended: 400x100px, transparent PNG
                                                </div>
                                            </div>

                                            <!-- Small Icon -->
                                            <div class="col-md-4 mb-3">
                                                <label for="brand_logo_small" class="form-label">
                                                    <strong>Small Icon / Favicon</strong>
                                                </label>
                                                ...
                                                <input type="file" class="form-control" 
                                                       id="brand_logo_small" 
                                                       name="brand_logo_small" 
                                                       accept="image/png,image/jpeg,image/svg+xml,image/x-icon">
                                                <div class="form-text">
                                                    <i class="fas fa-info-circle"></i> Recommended: 64x64px square
                                                </div>
                                            </div>

                                            <!-- White Logo -->
                                            <div class="col-md-4 mb-3">
                                                <label for="brand_logo_white" class="form-label">
                                                    <strong>White Logo (Dark BG)</strong>
                                                </label>
                                                @if($branding && $branding->logo_white_path)
                                                    <div class="mb-2 bg-dark p-2">
                                                        <img src="{{ asset('storage/' . $branding->logo_white_path) }}" 
                                                             alt="White Logo" 
                                                             class="img-thumbnail" 
                                                             style="max-height: 100px; background: transparent;">
                                                    </div>
                                                @endif
                                                <input type="file" class="form-control" 
                                                       id="brand_logo_white" 
                                                ...
                                                <div class="form-text">
                                                    <i class="fas fa-info-circle"></i> Recommended: 400x100px, white on transparent
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    colorInputs.forEach(colorInput => {
        ...
        // Update color picker if text input changes (for manual hex entry)
