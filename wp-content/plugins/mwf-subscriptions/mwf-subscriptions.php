...
// Get API URL from wp-config.php constants or use default
define('MWF_SUBS_API_URL', defined('MWF_API_URL') ? MWF_API_URL : '');
define('MWF_SUBS_API_KEY', defined('MWF_API_KEY') ? MWF_API_KEY : '');
...
require_once MWF_SUBS_PLUGIN_DIR . 'includes/class-mwf-box-customization.php';
...
class MWF_Subscriptions {
    ...
    public function init() {
        ...
        MWF_Box_Customization::instance();
